...
Case of 
	...
	: (at_frequency=2)  // Weekly
		...
		If (Form:C1466.e_schedule#Null:C1517)
			...
			For each ($vl_day;Form:C1466.e_schedule.detail.frequency.days)
	...
	: (at_frequency=3)  // Monthly
		...
		If (Form:C1466.e_schedule#Null:C1517)
			...
			If (Form:C1466.e_schedule.detail.frequency.monthChoice="onDay")
			...
			OBJECT SET ENABLED:C1123(*;"freq_monthly_button_@";(Form:C1466.frequencyOn=1))
			  ...
			  //Set dropdown values
			$vl_fia:=Find in array:C230(at_monthlyDayNum;Form:C1466.e_schedule.detail.frequency.onDay.dayNum)
			If ($vl_fia>0)
			...
			$vl_fia:=Find in array:C230(at_monthlyDayType;Form:C1466.e_schedule.detail.frequency.onDay.dayType)
			If ($vl_fia>0)
